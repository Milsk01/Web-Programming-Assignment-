        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 ">
                    <li class="nav-item">
                        <a class="nav-link me-2" href="#"><i class="bi bi-person-fill me-1"></i>Account</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link me-2 active" href="register_event.php"><i class="bi-card-list me-1"></i>Event</a>
                    </li>
                    <li class="nav-item">
